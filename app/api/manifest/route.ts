...
export function GET() {
  return NextResponse.json({
    ...
    endpoints: ["/api/mcp", "/api/manifest"],
    dataPolicy:
      "Contas, clientes, saldos e transacoes so sao acessiveis pelas MCP tools. Nao ha endpoint HTTP que devolva os dados do banco.",
  });
}
